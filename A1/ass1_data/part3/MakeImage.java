...
public class MakeImage implements MouseListener, MouseMotionListener {
    ...
    public MakeImage(String cn) {
        ...
        addButton(panel, "Clear", new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                clear();
            }
        });
        addButton(panel, "Left", new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                shift(-1, 0);
            }
        });
        addButton(panel, "Right", new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                shift(1, 0);
            }
        });
        addButton(panel, "Up", new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                shift(0, -1);
            }
        });
        addButton(panel, "Down", new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                shift(0, 1);
            }
        });
        addButton(panel, "Load", new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                load();
            }
        });
        addButton(panel, "SaveAs", new ActionListener() {
            public void actionPerformed(ActionEvent e) {
        ...
        addButton(panel, "Save", new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                save(null);
            }
        });
        ...
        cbutton.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                category = (category.equals(categoryName)) ? "O" : categoryName;
    ...
    public static void main(String[] args) {
        new MakeImage((args.length > 0) ? args[0] : "X");
    }
    ...
    private void save(String fname) {
        try {
            if (fname == null) {
                do
                    fname = category + ((category.equals(categoryName)) ? (++categoryCount) : (++otherCount)) + ".pbm";
            ...
            System.out.format("Save to file %s failed\n", fname);
        }
    }
    ...
    public void load() {
        ...
        try {
            ...
            if (!category.equals("O")) categoryName = category;
            rows = f.nextInt();
            cols = f.nextInt();
