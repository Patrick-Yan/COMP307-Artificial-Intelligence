...
def tenFoldstest(folderPath):

    trainingSet = pd.read_csv(folderPath + "/Part2/10trainSet/hepatitis-training-run-1.csv")
    testSet = pd.read_csv(folderPath + "/Part2/10testSet/hepatitis-test-run-1.csv")
    baselineClassifier(folderPath + "/Part2/10testSet/hepatitis-test-run-1.csv")
    num1 = acc_classify(trainingSet,testSet)

    trainingSet = pd.read_csv(folderPath + "/Part2/10trainSet/hepatitis-training-run-2.csv")
    testSet = pd.read_csv(folderPath + "/Part2/10testSet/hepatitis-test-run-2.csv")
    baselineClassifier(folderPath + "/Part2/10testSet/hepatitis-test-run-2.csv")
    num2 =acc_classify(trainingSet, testSet)

    trainingSet = pd.read_csv(folderPath + "/Part2/10trainSet/hepatitis-training-run-3.csv")
    testSet = pd.read_csv(folderPath + "/Part2/10testSet/hepatitis-test-run-3.csv")
    baselineClassifier(folderPath + "/Part2/10testSet/hepatitis-test-run-3.csv")
    num3 = acc_classify(trainingSet, testSet)

    trainingSet = pd.read_csv(folderPath + "/Part2/10trainSet/hepatitis-training-run-4.csv")
    testSet = pd.read_csv(folderPath + "/Part2/10testSet/hepatitis-test-run-4.csv")
    baselineClassifier(folderPath + "/Part2/10testSet/hepatitis-test-run-4.csv")
    num4 = acc_classify(trainingSet, testSet)

    trainingSet = pd.read_csv(folderPath + "/Part2/10trainSet/hepatitis-training-run-5.csv")
    testSet = pd.read_csv(folderPath + "/Part2/10testSet/hepatitis-test-run-5.csv")
    baselineClassifier(folderPath + "/Part2/10testSet/hepatitis-test-run-5.csv")
    num5 = acc_classify(trainingSet, testSet)

    trainingSet = pd.read_csv(folderPath + "/Part2/10trainSet/hepatitis-training-run-6.csv")
    testSet = pd.read_csv(folderPath + "/Part2/10testSet/hepatitis-test-run-6.csv")
    baselineClassifier(folderPath + "/Part2/10testSet/hepatitis-test-run-6.csv")
    num6 = acc_classify(trainingSet, testSet)

    trainingSet = pd.read_csv(folderPath + "/Part2/10trainSet/hepatitis-training-run-7.csv")
    testSet = pd.read_csv(folderPath + "/Part2/10testSet/hepatitis-test-run-7.csv")
    baselineClassifier(folderPath + "/Part2/10testSet/hepatitis-test-run-7.csv")
    num7 = acc_classify(trainingSet, testSet)

    trainingSet = pd.read_csv(folderPath + "/Part2/10trainSet/hepatitis-training-run-8.csv")
    testSet = pd.read_csv(folderPath + "/Part2/10testSet/hepatitis-test-run-8.csv")
    baselineClassifier(folderPath + "/Part2/10testSet/hepatitis-test-run-8.csv")
    num8 = acc_classify(trainingSet, testSet)

    trainingSet = pd.read_csv(folderPath + "/Part2/10trainSet/hepatitis-training-run-9.csv")
    testSet = pd.read_csv(folderPath + "/Part2/10testSet/hepatitis-test-run-9.csv")
    baselineClassifier(folderPath + "/Part2/10testSet/hepatitis-test-run-9.csv")
...
import graphviz
def drawTree():
    dataSet = pd.read_csv("/Users/Patrick/Desktop/hepatitis-training2.CSV") # Please change file path here
    ...
    Ytrain = Ytrain.apply(lambda x: labels.index(x))  #Convert this txt to numbers
    ...
    #Add labels and colors to graphics
    dot_data = tree.export_graphviz(clf, out_file=None,
    ...
    graphviz.Source(dot_data)
    #Use the render method to generate graphics
    graph = graphviz.Source(dot_data)
    graph.render("hepatitis3")


if __name__ == '__main__':

    trainingSet = pd.read_csv("/Users/Patrick/Desktop/Dataset/Part2/hepatitis-training.CSV")# Please change file path here
    testSet = pd.read_csv("/Users/Patrick/Desktop/Dataset/Part2/hepatitis-test.CSV")        # Please change file path here

    # Compare baseline and DT program
    print("--------------------Question 1---------------------")

    baselineClassifier("/Users/Patrick/Desktop/Dataset/Part2/hepatitis-test.CSV")           # Please change file path here
    acc_classify(trainingSet,testSet)

    print("--------------------Question 2---------------------")
    print("--------------------10 train & test---------------------")
    tenFoldstest("/Users/Patrick/Desktop/Dataset")  # ten training sets & test sets

    # drawTree()  # when call drawTree method , the picture will generate in the root folder
                  # and uncomments the drawTree() method above (from line 206)
